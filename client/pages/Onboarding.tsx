...
export default function Onboarding() {
  ...
  const careerGoals = [
    ...
    {
      id: "get_promoted",
      label: "Get promoted in current company",
      icon: TrendingUp,
    },
    {
      id: "salary_increase",
      label: "Increase salary significantly",
      icon: DollarSign,
    },
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateData("currentCompany", e.target.value)
                    }
                    className="pl-10"
                  />
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>💡 Tip:</strong> You can upgrade or downgrade your plan
                anytime from your dashboard settings. Start with Free to
                explore, then upgrade when you need more features!
              </p>
            </div>
          </div>
        );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Let's set up your profile to create amazing resumes
          </p>
        </div>
