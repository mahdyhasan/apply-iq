...
export default function JobMatchingSystem({ userPlan, onUpgrade }: JobMatchingProps) {
  ...
  const allJobs: Job[] = [
    ...
    },
    {
      ...
      posted: "2 days ago",
      match: 82,
      description: "Build e-commerce experiences for Bangladesh's leading online marketplace.",
    ...
    },
    {
      ...
      posted: "4 days ago",
      match: 76,
      description: "Manage infrastructure for Bangladesh's leading payment gateway.",
    ...
    },
    {
      ...
      posted: "5 days ago",
      match: 73,
      description: "Lead product strategy for Bangladesh's largest online grocery platform.",
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      const newJobs = currentLimit.jobs === -1 ? shuffled : shuffled.slice(0, currentLimit.jobs);
      setJobs(newJobs);
      setCanRefresh(true);
    }, 2000);
  };
  ...
  const jobCount = currentLimit.jobs === -1 ? allJobs.length : currentLimit.jobs;
    ...
    return (
      <Card>
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Job Matching Unavailable</h3>
          <p className="text-gray-600 mb-6">
            Upgrade to Starter plan to start seeing personalized job matches from top Bangladesh companies.
          </p>
    ...
    <div className="space-y-6">
        ...
        {currentLimit.refresh && (
          <div className="flex items-center space-x-3">
            ...
            <Button 
              ...
              disabled={!canRefresh}
            >
              <RefreshCw className={`h-4 w-4 mr-2 ${!canRefresh ? 'animate-spin' : ''}`} />
              Refresh Jobs
            </Button>
          </div>
        )}
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <Select value={companyFilter} onValueChange={setCompanyFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Daraz Bangladesh">Daraz Bangladesh</SelectItem>
                </SelectContent>
              </Select>
      ...
      {!currentLimit.refresh && userPlan === "starter" && (
        <Alert>
          ...
          <AlertDescription>
            Jobs are updated daily. Upgrade to Premium for 24-hour refresh and unlimited job matches!
          </AlertDescription>
        </Alert>
      )}
      ...
      {userPlan === "starter" && filteredJobs.length >= currentLimit.jobs && (
        <Alert>
          ...
          <AlertDescription>
            You're seeing {currentLimit.jobs} job matches. Upgrade to Premium to see all job matches 
            with unlimited refresh and advanced filters!
          </AlertDescription>
        </Alert>
      )}
